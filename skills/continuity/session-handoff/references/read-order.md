...
4. **`docs/DECISIONS.md`** — durable choices and their rationale, recorded by the decision-log skill (not by session-handoff). Explains why the project is shaped the way it is, so you don't re-litigate settled questions.
